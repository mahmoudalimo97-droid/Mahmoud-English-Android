...
// Eye-friendly mode background palettes
val SageCreamBg = Color(0xFFF7F9F6)
val WarmParchmentBg = Color(0xFFFBF8F1)
val NightForestBg = Color(0xFF081C15)
val NightForestSurface = Color(0xFF0E281F)
val NightForestCard = Color(0xFF14352B)
