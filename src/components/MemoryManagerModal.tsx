        ...
        <div className="space-y-2 pt-1">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 p-3 rounded-2xl bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-semibold shadow-xs transition-all active:scale-95"
            >
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 p-3 rounded-2xl bg-stone-100 hover:bg-stone-200 text-stone-800 text-xs font-semibold transition-all border border-stone-300"
            >
